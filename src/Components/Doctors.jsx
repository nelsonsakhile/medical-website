...
import doc1 from "../assets/img/Philadi1.jpg";
import doc2 from "../assets/img/IMG-20250116-WA0004.jpg";
import doc3 from "../assets/img/IMG-20250113-WA0002.jpg";

const Doctors = () => {
    const data = [
        {
            img: doc1,
            name: " Dr Queen Ngoatje",
            specialties: "GP"
        },
        {
            img: doc2,
            name: "Dr Bontle Phaladi",
            specialties: "GP"
        },
        {
            img: doc3,
            name: "Dr Selelo Motalaota.",
            specialties: "GP"
        }
    ];
